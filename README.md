...
> This package is forked from forked from [junedomingo/react-native-rename](https://github.com/junedomingo/react-native-rename).

**Note:** This package does not attempt to properly rename build artifacts such as `ios/build` or Cocoa Pod installation targets. After renaming your project you should clean, build, and reinstall third party dependencies to get it running properly with the new name.

### Usage
```
$ npx nx-react-native-rename@latest "new_name"
```

> With custom Bundle Identifier
```
$ npx nx-react-native-rename@latest "new_name" -b "bundle_identifier"
```
...
```
$ npx nx-react-native-rename "Travel App"
```
With custom Bundle Identifier
```
$ npx nx-react-native-rename "Travel App" -b "com.junedomingo.travelapp"
```
...
| `-e` or `--exclude` [value] | Comma-separated list of filenames to exclude from renaming operations. |
|   `--skipGitStatusCheck`   | Skip git repo status check                                                                                                                   |

### Local installation
With **Yarn**:
```
$ yarn global add nx-react-native-rename
```
With **npm**:
```
$ npm install nx-react-native-rename -g
```
